...
df= pd.read_csv('IndSum230125.csv')
...
set_n_estimators_rf = [10, 100, 200, 1000]
# set_n_estimators_rf = [100]
set_min_samples_leaf_rf = [2, 10]
...
def performance_mat(X_after_feat_sel, y, alpha_range, gamma_range, delta):
    ...
    return error_final, validation_forecast_flat, final_forecast_flat
...
for X_df_one in X_final_df:
    try:
        error_final, validation_forecast_flat, final_forecast_flat= performance_mat(X_df_one, y, alpha_range, gamma_range, delta)
